      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div>
              <label className="flex items-start">
                <input
                  ...
                  className="w-4 h-4 mt-0.5 text-[#2ECC71] border-gray-300 rounded focus:ring-[#2ECC71]"
                  required
                />
                <span className="ml-2 text-sm text-gray-600">
                  I agree to the{' '}
                  <Link to="/terms" className="text-[#2ECC71] hover:text-[#1E8449]">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link to="/privacy" className="text-[#2ECC71] hover:text-[#1E8449]">
                    Privacy Policy
                  </Link>
                </span>
              </label>
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link to="/signin" className="text-[#2ECC71] hover:text-[#1E8449] font-medium">
              Sign in
            </Link>
          </p>
        </div>
